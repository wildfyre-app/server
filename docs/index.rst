.. WildFyre API documentation master file, created by
    sphinx-quickstart on Tue Jan 24 13:53:36 2017.
    You can adapt this file completely to your liking, but it should at least
    contain the root `toctree` directive.

==========================================
Welcome to the WildFyre API documentation!
==========================================
...
in `RFC 2119 <https://tools.ietf.org/html/rfc2119>`_.


.. note::
    The api uses the HTTP Status codes. You SHOULD always check them.

.. warning::
    Your use of this api MUST be in condition to the WildFyre terms.
    ...
    **If you offend against our terms we might file a suit against you.**

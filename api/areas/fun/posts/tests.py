...
class PostTest(TestCase):
    ...
    def test_not_authenticated(self):
        ...
        """
        request = self.factory.get(reverse('areas:fun:posts:post'))
    ...
    def test_create_post(self):
        ...
        Create a new post
        """
        request = self.factory.post(reverse('areas:fun:posts:post'), {'text': "Hi"})
        force_authenticate(request, self.user)
        response = PostView.as_view()(request)
...
class DetailTest(TestCase):
    ...
    def test_view_post(self):
        ...
        Try to view a post
        """
        request = self.factory.get(reverse('areas:fun:posts:detail', kwargs={'pk': self.post.pk, 'nonce': self.post.nonce}))
    ...
    def test_delete_post(self):
        ...
        Try to delete post
        """
        request = self.factory.delete(reverse('areas:fun:posts:detail', kwargs={'pk': self.post_own.pk, 'nonce': self.post_own.nonce}))
        force_authenticate(request, self.user)
    ...
    def test_delete_others(self):
        ...
        """
        request = self.factory.delete(reverse('areas:fun:posts:detail', kwargs={'pk': self.post.pk, 'nonce': self.post.nonce}))
        force_authenticate(request, self.user)
        response = DetailView.as_view()(request, pk=self.post.pk, nonce=self.post.nonce)
...
class OwnTest(TestCase):
    ...
    def test_not_authenticated(self):
        ...
        Status code 401: Unauthorized should be raised
        """
        request = self.factory.get(reverse('areas:fun:posts:own'))
        request.user = AnonymousUser()
        response = PostView.as_view()(request)
...
class SpreadTest(TestCase):
    ...
    def test_spread_true(self):
        ...
        request = self.factory.post(reverse('areas:fun:posts:spread', kwargs={
            'pk': self.post.id,
...
class CommentTest(TestCase):
    ...
    def test_not_authenticated(self):
        ...
        Status code 401: Unauthorized should be raised
        """
        request = self.factory.post(reverse('areas:fun:posts:detail', kwargs={'pk': self.post.pk, 'nonce': self.post.nonce}),
                                   {'text': "hi"})
        request.user = AnonymousUser()
        response = PostView.as_view()(request)
